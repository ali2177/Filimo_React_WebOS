...
// Shared hero shell. Owns the single persistent background <img> whose `src`
// is driven by the parent (`bgSrc`). In "movie" mode it renders the focused
// movie overlay; the slider overlay (if any) is passed in as `children`.
const Content = ({ bgSrc, currentFocusedMovie, mode = "movie", children }) => {
  const showMovieOverlay =
    mode === "movie" && currentFocusedMovie && currentFocusedMovie?.cover;

  return (
    <div className="content">
      <div className="gradiant"></div>
      <img className="content-poster" src={bgSrc} alt="" />
